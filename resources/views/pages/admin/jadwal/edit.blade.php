            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Edit jadwal pada hari {{ $jadwal->hari }}</h4>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jadwal.update', $jadwal->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="ruangan_id" name="ruangan_id" class="select2 form-control ">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="sampai_jam" id="time2" @error('sampai_jam') is-invalid @enderror" placeholder="{{ __('Nama Prodi') }}" value="{{ $jadwal->sampai_jam ?? '' }}" />
                            </div>
