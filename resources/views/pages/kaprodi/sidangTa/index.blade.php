    ...
    <div class="section-body">
        <div class="row">
                                    ...
                                    @foreach($jadwals as $jadwal)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('sidang_ta.edit', Crypt::encrypt($jadwal->id)) }}" class="btn btn-success btn-sm"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
                                                <form method="POST" action="{{ route('sidang_ta.destroy', $jadwal->id) }}">
                                                    @csrf
                                                    @method('delete')
            ...
            <div class="modal-body">
                <form action="{{ route('sidang_ta.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            @if ($errors->any())
