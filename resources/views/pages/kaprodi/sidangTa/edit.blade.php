                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>Edit Jadwal</h4>
                            <a href="{{ route('sidang_ta.index') }}" class="btn btn-primary">Kembali</a>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('sidang_ta.update', $jadwal->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    <label for="penguji1_id">Anggota 1</label>
                                ...
                                <div class="form-group">
                                    <label for="penguji2_id">Anggota 2</label>
