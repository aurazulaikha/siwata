            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div>
                            <a href="{{ route('report.nilai') }}" class="btn btn-primary me-3">
                                <i class="nav-icon fas fa-folder-plus"></i>&nbsp; Report Nilai Sidang TA
                            </a>
                            <a href="{{ route('report.status') }}" class="btn btn-primary me-3">
                                <i class="nav-icon fas fa-folder-plus"></i>&nbsp; Report Status Kelulusan
                            </a>
                            <a href="{{ route('report.penguji') }}" class="btn btn-primary me-3">
