                                ...
                                <tbody>
                                    @foreach($jadwals as $jadwal)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('nilaiTa.ketua', $jadwal->id) }}" class="btn btn-success btn-sm">
                                                    <i class="nav-icon fas fa-edit"></i> &nbsp;Lihat Nilai
                                                </a>
                                                @if(
                                                    is_null($jadwal->nilaiKetua) ||
                                                    $jadwal->nilaiKetua->isEmpty() ||
                                                    $jadwal->nilaiKetua->contains(function ($item) {
                                                    ...
                                                    <a href="{{ route('nilaiKetua.create', $jadwal->id) }}" class="btn btn-success btn-sm">Input Nilai</a>
                                                @endif
                                            </td>
                                        </tr>
