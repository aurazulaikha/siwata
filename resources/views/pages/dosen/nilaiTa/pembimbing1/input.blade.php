...
@section('title', 'Input Nilai Pembimbing 1')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4>Input Nilai Pembimbing 1</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('nilaiPembimbing1.store', $sidangTa->id) }}" method="POST" id="nilaiForm">
                            @csrf
                            @method('PUT')
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>
                                                <input type="number" name="b1" class="form-control score-input" step="0.01" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>
                                                <input type="number" name="b2" class="form-control score-input" step="0.01" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>20</td>
                                            <td>
                                                <input type="number" name="b3" class="form-control score-input" step="0.01" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
